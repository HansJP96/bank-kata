...
public class PrintTable {
    ...
    private final List<Map<String, String>> rowData;
    private final int rowsNumber;
    private final int columnNumber;

    public PrintTable(String[] tableHeaders, List<Map<String, String>> rowData) {
    ...
    private Object[] transformRowColumns(Map<String, String> data) {
